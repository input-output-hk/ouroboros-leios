...
The source data is [`cardano-db-sync`](https://github.com/IntersectMBO/cardano-db-sync) and [`db-analyser`](https://github.com/IntersectMBO/ouroboros-consensus/blob/main/ouroboros-consensus-cardano/README.md#db-analyser).
...
| Reapply [ms]               | Mean `reapply_mux` measurement from `db-analyser` for blocks in this bin. |
