...
\scenarioVsIdealFigure{scenario2}{scenario2}
...
\scenarioVsIdealFigure{scenario3}{scenario3}

\section{Scenario \ref{sc:tcp}}
\label{scenario4}
Fig.~\ref{fig:scenario4}
\scenarioVsIdealFigure{scenario4}{scenario4}

\section{Scenario \ref{sc:boundedcpu}}
\label{scenario5}
Fig.~\ref{fig:scenario5}
\scenarioVsIdealFigure{scenario5}{scenario5}

\section{Scenario \ref{sc:order}}
\label{scenario6}
Fig.~\ref{fig:scenario6}
\scenarioVsIdealFigure{scenario6}{scenario6}
