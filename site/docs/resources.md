...
- [Linear Leios](https://leios.cardano-scaling.org/formal-spec/Leios.Linear.html)
- [Network basic broadcast](https://leios.cardano-scaling.org/formal-spec/Network.BasicBroadcast.html)
...
- [Leios overview
  ...
  – presentation by Sandro Coretti-Drayton providing insights into Leios.
...
- [Leios use cases](leios-use-cases.md) – discover how Ouroboros Leios, Cardano’s next-generation protocol, could enable unique use cases like global microtransactions, supply chain tracking, and more, outshining other blockchains.
