...
mongoexport --host="$HOST" \
            ...
            --collection=receipts \
            --type=csv \
            --fields='simulator,network,label,leios-stage-length-slots,ib-generation-probability,ib-body-avg-size-bytes,eb-generation-probability,kind,item,producer,recipient,size,sent,received,elapsed' \
