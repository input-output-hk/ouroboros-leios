...
\begin{tikzpicture}
    ...
    \path[-stealth] (focus) edge[out=45,in=135,looseness=25, color=jasper] node[above] {\textcolor{black}{$Base_{1}$}} (focus);
    \path[-stealth] (focus) edge[out=45,in=135,looseness=30, color=jasper, dashed] node[above] {\textcolor{black}{Ftch}} (focus);
