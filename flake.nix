{
  ...
  inputs = {
    ...
    # Used by demo/
    ouroboros-consensus.url = "github:intersectmbo/ouroboros-consensus?ref=mw/leios-prototype";
    cardano-node-leios.url = "github:intersectmbo/cardano-node?ref=mw/leios-prototype";
