{
  ...
  inputs = {
    ...
    # Used by demo/
    ouroboros-consensus.url = "github:intersectmbo/ouroboros-consensus?ref=ch1bo/leios-prototype-threadnet";
    cardano-node-leios.url = "github:intersectmbo/cardano-node?ref=leios-prototype-refactored-db";
