...
The trace translator translates traces generated by the Praos node into traces in the format expected by the [Leios trace verifier](https://github.com/input-output-hk/ouroboros-leios/tree/main/leios-trace-verifier).
